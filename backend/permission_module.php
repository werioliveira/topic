      ...
      <div class="row">
        <div class="col-md-6">
          <div class="card card-primary">
            ...
            <form action="/backend/permission_post.php" method="post">
            <div class="card-body">
              <div class="form-group">
                <label for="inputName">Create</label>
                <input type="number" id="inputName" class="form-control" name="create">
              </div>
              <div class="form-group">
                <label for="inputUpdate">UPDATE</label>
                <input type="number" id="inputUpdate" class="form-control" name="update">
              </div>
              <div class="form-group">
                <label for="inputSelect">SELECT</label>
                <input type="number" id="inputSelect" class="form-control" name="select">
              </div>
              <div class="form-group">
                <label for="inputDelete">DELETE</label>
                <input type="number" id="inputDelete" class="form-control" name="delete">
              </div>
