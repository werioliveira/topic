  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php $url/logout.php?>" class="nav-link">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
            ...
            <div class="card">
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-striped table-valign-middle">
                  ...
                  <tr>
                    <td>
                      <img src="../design/dist/img/default-150x150.png" alt="Product 1" class="img-circle img-size-32 mr-2">
                      Some Product
                    </td>
                    <td>$13 USD</td>
                    <td>
...
<script src="../design/dist/js/pages/dashboard3.js"></script>
</body>
</html>
